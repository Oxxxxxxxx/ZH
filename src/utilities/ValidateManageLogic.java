...
public class ValidateManageLogic {
	public static String validateManageTrainer(HttpServletRequest request) { if(request.getParameter("UPDATE")!=null
	...
	public static void navigateJS(PrintWriter out) { out.println("<SCRIPT type=\"text/javascript\">");
	out.println("alert(\"Record has been updated and url will be redirected\")"); 
	out.println("window.location.assign(\"PaginationServlet?currentPage=1&recordsPerPage=70\")");
	out.println("</SCRIPT>");
	}
	}
